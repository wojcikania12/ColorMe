...
import './App.css';
export default class UploadLineartScreen extends React.Component{
	constructor(){
		super();
		this.state = {
	        selectedFile: null,
  ...
  handleClose = () => {
	...
	onClickHandler = () => {
	 	...
	 	let url= 'http://0.0.0.0:5000/color/lineart';
	...
	showResult(){
		...
		img.src="data:image/png;base64,"+this.state.coloredResponse;
		const pointer = this;
		img.onload = function(){
    ...
    Wybierz kolor filtra   
					...
					<a href={"data:image/png;base64,"+this.state.coloredResponse} download className="App-button" >
						Pobierz rezultat
					</a> 
			        ...
			        <div className="App-left-side">
				        <div className="left-side-content">
				       	<a href="/" ><img src={logo} className="left-side-logo" /></a>
					        <p>Wybierz lineart, który chcesz pokolorować</p>
					        <label className="custom-file-upload">
					        <p>
					        {this.state.selectedFile==null? "Wybierz lineart" : this.state.selectedFile.name}
					        </p>
					       <br/>
